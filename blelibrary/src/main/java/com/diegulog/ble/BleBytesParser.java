...
public class BleBytesParser {
     ...
     */
    public BleBytesParser(ByteOrder byteOrder) {
        this(null, byteOrder);
    }
     ...
     */
    public BleBytesParser(byte[] value) {
     ...
     */
    public BleBytesParser(byte[] value, ByteOrder byteOrder) {
     ...
     */
    public BleBytesParser(byte[] value, int offset) {
     ...
     */
    public BleBytesParser(byte[] value, int offset, ByteOrder byteOrder) {
        mValue = value;
        this.offset = offset;
