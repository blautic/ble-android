...
import com.diegulog.ble.PeripheralType;
...
import static com.diegulog.ble.BleBytesParser.bytes2String;

/**
 * Represents a remote Bluetooth peripheral and replaces BluetoothDevice and BluetoothGatt
 *
 * <p>A {@link BlePeripheral} lets you create a connection with the peripheral or query information about it.
...
public class BlePeripheral {
    ...
    protected @NotNull BlePeripheralCallback peripheralCallback;
    ...
    private final BluetoothGattCallback bluetoothGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(@NotNull final BluetoothGatt gatt, final int status) {
            ...
            listener.connected(BlePeripheral.this);

            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    peripheralCallback.onServicesDiscovered(BlePeripheral.this);
                }
            });
        }
        ...
        public void onDescriptorWrite(@NotNull final BluetoothGatt gatt, @NotNull final BluetoothGattDescriptor descriptor, final int status) {
            ...
            if (descriptor.getUuid().equals(CCC_DESCRIPTOR_UUID)) {
                ...
                callbackHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        peripheralCallback.onNotificationStateUpdate(BlePeripheral.this, parentCharacteristic, gattStatus);
                    }
                });
            } else {
                callbackHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        peripheralCallback.onDescriptorWrite(BlePeripheral.this, currentWriteBytes, descriptor, gattStatus);
                    }
                });
            }
            completedCommand();
        ...
        public void onDescriptorRead(@NotNull final BluetoothGatt gatt, @NotNull final BluetoothGattDescriptor descriptor, final int status) {
            ...
            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    peripheralCallback.onDescriptorRead(BlePeripheral.this, value, descriptor, gattStatus);
                }
            });
            completedCommand();
        }
        ...
        public void onCharacteristicChanged(@NotNull final BluetoothGatt gatt, @NotNull final BluetoothGattCharacteristic characteristic) {
            ...
            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    peripheralCallback.onCharacteristicUpdate(BlePeripheral.this, value, characteristic, GattStatus.SUCCESS);
                }
            });
        }
        ...
        public void onCharacteristicRead(@NotNull final BluetoothGatt gatt, @NotNull final BluetoothGattCharacteristic characteristic, final int status) {
            ...
            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    peripheralCallback.onCharacteristicUpdate(BlePeripheral.this, value, characteristic, gattStatus);
                }
            });
            completedCommand();
        }
        ...
        public void onCharacteristicWrite(@NotNull final BluetoothGatt gatt, @NotNull final BluetoothGattCharacteristic characteristic, final int status) {
            ...
            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    peripheralCallback.onCharacteristicWrite(BlePeripheral.this, value, characteristic, gattStatus);
                }
            });
            completedCommand();
        }
        ...
        public void onReadRemoteRssi(@NotNull final BluetoothGatt gatt, final int rssi, final int status) {
            ...
            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    peripheralCallback.onReadRemoteRssi(BlePeripheral.this, rssi, gattStatus);
                }
            });
            completedCommand();
        }
        ...
        public void onMtuChanged(@NotNull final BluetoothGatt gatt, final int mtu, final int status) {
            ...
            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    peripheralCallback.onMtuChanged(BlePeripheral.this, mtu, gattStatus);
                }
            });
        ...
        public void onPhyRead(@NotNull final BluetoothGatt gatt, final int txPhy, final int rxPhy, final int status) {
            ...
            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    peripheralCallback.onPhyUpdate(BlePeripheral.this, PhyType.fromValue(txPhy), PhyType.fromValue(rxPhy), gattStatus);
                }
            });
            completedCommand();
        }
        ...
        public void onConnectionUpdated(@NotNull final BluetoothGatt gatt, final int interval, final int latency, final int timeout, final int status) {
            ...
            callbackHandler.post(new Runnable() {
                @Override
                public void run() {
                    peripheralCallback.onConnectionUpdated(BlePeripheral.this, interval, latency, timeout, gattStatus);
                }
            });
        }
    };
    ...
    private void successfullyDisconnected(final int previousState) {
        ...
        if (bondLost) {
            ...
            callbackHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    listener.connectFailed(BlePeripheral.this, HciStatus.SUCCESS);
                }
    ...
    private void connectionStateChangeUnsuccessful(@NotNull final HciStatus status, final int previousState, final int newState) {
        ...
        if (previousState == BluetoothProfile.STATE_CONNECTING) {
            ...
            listener.connectFailed(BlePeripheral.this, adjustedStatus);
            ...
            listener.connectFailed(BlePeripheral.this, status);
        } else {
        ...
        switch (bondState) {
            case BOND_BONDING:
                ...
                callbackHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        peripheralCallback.onBondingStarted(BlePeripheral.this);
                    }
                });
                break;
            case BOND_BONDED:
                ...
                callbackHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        peripheralCallback.onBondingSucceeded(BlePeripheral.this);
                    }
                });
            ...
            case BOND_NONE:
                if (previousBondState == BOND_BONDING) {
                    ...
                    callbackHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            peripheralCallback.onBondingFailed(BlePeripheral.this);
                        }
                    });
                } else {
                    ...
                    callbackHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            peripheralCallback.onBondLost(BlePeripheral.this);
                        }
                    });
                }
                disconnect();
    ...
    private final BroadcastReceiver pairingRequestBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (variant == PAIRING_VARIANT_PIN) {
                final String pin = listener.getPincode(BlePeripheral.this);
                if (pin != null) {
     ...
     * @param listener Callback to {@link com.diegulog.ble.BleManager}.
     */
    public BlePeripheral(@NotNull final Context context, @NotNull final BluetoothDevice device, @NotNull final InternalCallback listener, @NotNull final BlePeripheralCallback peripheralCallback, @NotNull final Handler callbackHandler) {
    ...
    public void setPeripheralCallback(@NotNull final BlePeripheralCallback peripheralCallback) {
        this.peripheralCallback = Objects.requireNonNull(peripheralCallback, NO_VALID_PERIPHERAL_CALLBACK_PROVIDED);
    }

    public void setDevice(@NotNull final BluetoothDevice bluetoothDevice) {
        ...
        if (state == BluetoothProfile.STATE_DISCONNECTED) {
            mainHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    startConnectionTimer(BlePeripheral.this);
                }
     ...
     * receive updates via the {@link BlePeripheralCallback}. Otherwise the bonding will
     ...
     *
     * <p>When the disconnection has been completed {@link com.diegulog.ble.BleManagerCallback#onDisconnectedPeripheral(BlePeripheral, HciStatus)} will be called.
     */
    private void disconnect() {
        if (state == BluetoothProfile.STATE_CONNECTED || state == BluetoothProfile.STATE_CONNECTING) {
            ...
            listener.disconnected(BlePeripheral.this, HciStatus.SUCCESS);
        }
    }
    ...
    private void completeDisconnect(final boolean notify, @NotNull final HciStatus status) {
        ...
        bondLost = false;
        if (notify) {
            listener.disconnected(BlePeripheral.this, status);
        }
    }
     ...
     * Only services that are also supported by {@link com.diegulog.ble.BleManager} are included.
     *
     ...
     * Read the value of a characteristic.
     *
     * <p>{@link BlePeripheralCallback#onCharacteristicUpdate(BlePeripheral, byte[], BluetoothGattCharacteristic, GattStatus)}   will be triggered as a result of this call.
     *
     ...
     */
    public boolean writeCharacteristic(@NotNull final UUID serviceUUID, @NotNull final UUID characteristicUUID, @NotNull final byte[] value) {
        Objects.requireNonNull(serviceUUID, NO_VALID_SERVICE_UUID_PROVIDED);
        Objects.requireNonNull(characteristicUUID, NO_VALID_CHARACTERISTIC_UUID_PROVIDED);
     ...
     *
     * <p>{@link BlePeripheralCallback#onCharacteristicWrite(BlePeripheral, byte[], BluetoothGattCharacteristic, GattStatus)} will be triggered as a result of this call.
     *
     ...
     * @throws IllegalArgumentException if the characteristic does not support writing with the specified writeType or the byte array is empty or too long
     */
    public boolean writeCharacteristic(@NotNull final BluetoothGattCharacteristic characteristic, @NotNull final byte[] value) {
        Objects.requireNonNull(characteristic, NO_VALID_CHARACTERISTIC_PROVIDED);
        Objects.requireNonNull(value, NO_VALID_VALUE_PROVIDED);
     ...
     *
     * <p>For turning on/off notifications use {@link BlePeripheral#setNotify(BluetoothGattCharacteristic, boolean)} instead.
     *
     ...
     * Set the notification state of a characteristic to 'on' or 'off'. The characteristic must support notifications or indications.
     *
     * <p>{@link BlePeripheralCallback#onNotificationStateUpdate(BlePeripheral, BluetoothGattCharacteristic, GattStatus)} will be triggered as a result of this call.
     *
     ...
     *
     * <p>{@link BlePeripheralCallback#onReadRemoteRssi(BlePeripheral, int, GattStatus)} will be triggered as a result of this call.
     *
     ...
     * <p>{@link BlePeripheralCallback#onMtuChanged(BlePeripheral, int, GattStatus)} will be triggered as a result of this call.
     *
     ...
     * <p>
     * {@link BlePeripheralCallback#onPhyUpdate} will be triggered as a result of this call, even
     ...
     * in {@link BlePeripheralCallback#onPhyUpdate}
     */
    ...
    public interface InternalCallback {
        ...
        /**
         * {@link BlePeripheral} has successfully connected.
         *
         * @param device {@link BlePeripheral} that connected.
         */
        void connected(@NotNull BlePeripheral device);

        /**
         * Connecting with {@link BlePeripheral} has failed.
         *
         * @param device {@link BlePeripheral} of which connect failed.
         */
        void connectFailed(@NotNull BlePeripheral device, @NotNull final HciStatus status);

        /**
         * {@link BlePeripheral} has disconnected.
         *
         * @param device {@link BlePeripheral} that disconnected.
         */
        void disconnected(@NotNull BlePeripheral device, @NotNull final HciStatus status);

        String getPincode(@NotNull BlePeripheral device);
    ...
    private void startConnectionTimer(@NotNull final BlePeripheral peripheral) {
        cancelConnectionTimer();
